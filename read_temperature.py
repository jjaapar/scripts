...
AWS_REGION = "us-east-1"  # AWS region for CloudWatch logs
...
# Configure logging to write to a file and display on screen
logging.basicConfig(
...
def read_temperature():
    ...
    logs it locally, displays it on screen, and uploads it to AWS CloudWatch.
    """
            ...
            while True:
                ...
                if raw_response:
                    ...
                    try:
                        ...
                        # Format, log, and display the data
